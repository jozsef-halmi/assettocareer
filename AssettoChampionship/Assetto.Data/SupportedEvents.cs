...
namespace Assetto.Data
{
    public class SupportedEvents
    {
        ...
        public static EventData PorscheGT4_Monza = new EventData()
        {
            Id = "PorscheGT4_Monza",
        ...
        public static EventData PorscheGT4_Silverstone = new EventData()
        {
        ...
        public static EventData PorscheGT4_Barcelona = new EventData()
        {
            Id = "PorscheGT4_Barcelona",
            FriendlyName = "GT4 European Series at Barcelona",
            JumpStartPenalty = Common.Enum.JumpStartPenaltyType.DriveThrough,
            ...
            CareerSessions = new List<SessionData>() {
                ...
                SupportedSessions.PorscheGT4BarcelonaQualy,
                SupportedSessions.PorscheGT4BarcelonaRace1
            },
            Description = ""
        };

        public static EventData PorscheGT4_Spa = new EventData()
        {
            Id = "PorscheGT4_Spa",
            FriendlyName = "GT4 European Series at Spa",
            JumpStartPenalty = Common.Enum.JumpStartPenaltyType.DriveThrough,
            ...
            CareerSessions = new List<SessionData>() {
                ...
                SupportedSessions.PorscheGT4SpaQualy,
                SupportedSessions.PorscheGT4SpaRace1
            },
            Description = ""
        };

        public static EventData PorscheGT4_Zandvoort = new EventData()
        {
            Id = "PorscheGT4_Zandvoort",
            FriendlyName = "GT4 European Series at Zandvoort",
            JumpStartPenalty = Common.Enum.JumpStartPenaltyType.DriveThrough,
            ...
            CareerSessions = new List<SessionData>() {
                ...
                SupportedSessions.PorscheGT4ZandvoortQualy,
                SupportedSessions.PorscheGT4ZandvoortRace1
            },
            Description = ""
        };
